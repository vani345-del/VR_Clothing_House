            ...
            <div>
             ...
             <div>
                ...
                <ul className='space-y-2 text-gray-600'>
                    <li>
                        <Link to='#' className='hover:text-gray-500 transition-colors'>Kids Ware
                        </Link>
                    </li>
                    <li>
                        <Link to='#' className='hover:text-gray-500 transition-colors'>Sarees
                        </Link>
                    </li>
                    <li>
                        <Link to='#' className='hover:text-gray-500 transition-colors'>Dresses
                        </Link>
                    </li>
